        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="sub-heading">
                    <p>
                        Update existing products for customers via Product ID.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="cform" id="contact-form">
                    <form action="vendor_edit_products.php" method="post" role="form" class="contactForm">
                        <div class="form-group">
                            <label>Product ID</label>
                            <input class="form-control" type="text" name="product_id" placeholder="Product ID" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="product_description"rows="5" placeholder="Product Description" required></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button class="btn btn-lg btn-success btn-block" type="submit" name="submit">Update product</button>
                        </div>
                    </form>
                </div>
            </div>
