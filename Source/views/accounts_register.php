                    ...
                    <div class="cform" id="contact-form">
                        <form action="accounts_register_validate.php" method="post" role="form" class="contactForm">
                            <div class="form-group">
                                ...
                                <input type="text" name="vendor_company_name" class="form-control" title="Enter Company Name" placeholder="Company Name" value="<?php echo $_SESSION['vendor_company_name'];?>" required />
                            </div>
                            <div class="form-group">
